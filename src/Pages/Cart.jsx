            ...
            <div className='mt-10'>
              {cartItem?.map((item, index) => {
                return <div key={index} className='bg-gray-100 p-5 rounded-md flex items-center justify-between mt-3 w-full'>
                  ...
                  <span className='hover:bg-white/60 transition-all rounded-full p-3 hover:shadow-2xl'><FaRegTrashAlt className='text-red-500 text-2xl cursor-pointer'/></span>
                </div>
              })}
            </div>
            ...
            <div className='grid grid-cols-2 gap-20'>
              <div className='bg-gray-100 rounded-md p-7 mt-4 space-y-2'>
                ...
                <div className='flex flex-col space-y-1'>
                  ...
                  <input type="text" name="" id="" placeholder='Enter Your Name' className='p-2 rounded-md'/>
                </div>
                <div className='flex flex-col space-y-1'>
                  <label htmlFor="">Address</label>
                  <input type="text" name="" id="" placeholder='Enter Your Address' className='p-2 rounded-md'/>
                </div>
                ...
                <div className='flex w-full gap-5'>
                  ...
                  <div className='flex flex-col space-y-1 w-full'>
                    ...
                    <input type="text" placeholder='Enter Your Mob' className='p-2 rounded-md w-full'/>
                  </div>
                </div>
                ...
                <div className='flex justify-center'>
                  <button className='bg-red-500 text-white px-3 py-1 rounded-md mt-3 cursor-pointer'>Detect Location</button>
                </div>
              </div>
              ...
              <div className='bg-white border-gray-200 shadow-xl rounded-md p-7 mt-4 space-y-2 h-max'>
                ...
                <div>
                  ...
                  <div className='flex gap-3'>
                    ...
                    <button className='bg-white text-black border border-gray-200 cursor-pointer px-4 py-1 rounded-md hover:bg-black hover:text-white'>Apply</button>
                  </div>
                </div>
